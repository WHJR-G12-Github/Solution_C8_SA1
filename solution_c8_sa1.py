...
# Creating a font of type 'freesansbold.ttf' in size '30' and naming it 'gameover_font'
...
while True:
  ...
  if player.y>600:
      player.y=0
  # Checking if the value of 'over' is "True"
  if over:
      # Creating the text to be displayed using 'gameover_font' and naming it 'gameover_text'
      # Text to be displayed, "True", color are passed as arguments
      gameover_text=gameover_font.render("GAME OVER!",True,YELLOW)
      # Displaying the 'gameover_Text' at the location (100,250)
